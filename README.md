...
The original package is no longer supported. The latest version of the package has a conflict with the popular Guzzle package.
Discussions:
- https://github.com/coinbase/coinbase-commerce-php/issues/35
- https://github.com/coinbase/coinbase-commerce-php/issues/65

A fork was created by a third-party user to fix the issue, but later, they deleted their Github account. This package restores that version.
...
``` sh
composer require zamay86/coinbase-commerce
```
## Usage
``` php
use CoinbaseCommerce\ApiClient;
